...
} from '@/features/admin/services/adminDashboard';
import type {
  DashboardStats,
  RecentActivity,
  SystemTrends,
...
import DashboardKPIs from '@/features/admin/components/DashboardKPIs';
import DashboardCharts from '@/features/admin/components/DashboardCharts';
import RecentActivityComponent from '@/features/admin/components/RecentActivity';
import QuickLinks from '@/features/admin/components/QuickLinks';
