...
import { listPruebasByLeccion } from '@/features/pruebas/services/pruebas';
import { getProgresoByUsuarioAndLeccion, upsertProgresoLastAccess } from '@/shared/services/progresos';
import { listModelosByLeccion } from '@/features/models3d/services/modelos';
import { listSeccionesCompletasByLeccion } from '@/features/lessons/services/leccionSecciones';
import { marcarSeccionCompletada, getEstadisticasProgresoLeccion } from '@/shared/services/progresoSecciones';
import { getModeloPrincipalByContenido } from '@/features/models3d/services/contenidoModelos';
import { getSiguienteLeccion } from '@/features/lessons/services/lecciones';
import { parseId } from '@/shared/lib/parseId';
import type { Leccion, Prueba, ContenidoConLecciones, Progreso, ModeloRA, Contenido, ContenidoLeccion, LeccionSeccionCompleta } from '@/shared/types';
...
import TakePruebaModal from '@/features/pruebas/components/TakePruebaModal';
import EditPruebaModal from '@/features/pruebas/components/EditPruebaModal';
import ModelViewerModal from '@/features/models3d/components/ModelViewerModal';
