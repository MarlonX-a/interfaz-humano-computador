...
import { getProgresosByUsuario, getCompletionPercentsForUser } from '@/shared/services/progresos';
import { getEstadisticasProgresoLeccion } from '@/shared/services/progresoSecciones';
import { parseId } from '@/shared/lib/parseId';
import type { Leccion, Progreso } from '@/shared/types';
